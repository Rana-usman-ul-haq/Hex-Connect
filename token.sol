...
contract HexConnect is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Hex Coneect", "Hex CON")  {
        rewardToken = 0x57fde0a71132198BBeC939B98976993d8D89D225;
        _marketingWalletAddress = 0x31b5B830a8B02D79b1933ce7aBDe74230BA3908e;// update marketing wallet
        ...
        maxWalletLimit = 1000000000 * (10**18);
        maxBuyLimit = 1000000000 * (10**18);
